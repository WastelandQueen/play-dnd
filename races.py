...
class CharRace:
    ...
    def getScores(a_race):
        char_scores = [a_race.str, a_race.dex, a_race.con, a_race.int, a_race.wis, a_race.cha]
        return char_scores

#                                                           S, D, C, I, W, C
Dwarf_Hill =            CharRace("Hill Dwarf",          25, 0, 0, 2, 0, 1, 0, "(1) Darkvision\n(2) Dwarven Resiliance\n(3) Dwarven Combat Training\n(4) Tool Proficiency\n(5) Stonecunning\n(6) Dwarven Toughness\nLanguages: Common and Dwarvish")
...
Elf_Wood =              CharRace("Wood Elf",            35, 0, 2, 0, 0, 1, 0, "(1) Darkvision\n(2) Keen Senses\n(3) Fey Ancestry\n(4) Trance\n(5) Elf Weapon Training\n(6) Fleet of Foot\n(7) Mask of the Wild\nLanguages: Common and Elvish")
Elf_Dark =              CharRace("Dark Elf",            30, 0, 2, 0, 0, 0, 1, "(1) Superior Darkvision\n(2) Keen Senses\n(3) Fey Ancestry\n(4) Trance\n(5) SunJight Sensitivity\n(6) Drow Magic\n(7) Drow Weapon Training\nLanguages: Common and Elvish")

Halfling_Lightfoot =    CharRace("Lightfoot Halfling",  25, 0, 2, 0, 0, 0, 1, "(1) Lucky\n(2) Brave\n(3) Halfling Nimbleness\n(4) Naturally Stealthy\nLanguages: Common and Halfling")
...
Dragonborn =            CharRace("Dragonborn",          30, 2, 0, 0, 0, 0, 1, "(1) Draconic Ancestry\n(2) Breath Weapon\n(3) Damage Resistance\nLanguages: Common and Draconic")
...
Tiefling =              CharRace("Tiefling",            30, 0, 0, 0, 1, 0, 2, "(1) Darkvision\n(2) Hellish Resistance\n(3) Infernal Legacy\nLanguages: Common and Infernal")

Aarakocra =             CharRace("Aarakocra",           25, 0, 2, 0, 0, 1, 0, "(1) Flight\n(2) Talons\nLanguages: Common, Aarakocra, and Auran")
...
Genasi_Water =          CharRace("Water Genasi",        30, 0, 0, 2, 0, 1, 0, "(1) Amphibious\n(2) Swim\n(3) Call to the Wave\nLanguages: Common and Primordial")
